...
To use this script:
1. Replace MAC_ADDRESS with your ring's actual MAC address
2. Run: python monitor_ring.py
"""
...
async def main():
    ...
    MAC_ADDRESS = "1A:8E:08:AC:1E:97"  # Your ring's MAC address
    
    if MAC_ADDRESS == "XX:XX:XX:XX:XX:XX":
        print("ERROR: Please update the MAC_ADDRESS variable with your ring's actual MAC address")
        print("Example: MAC_ADDRESS = '12:34:56:78:9A:BC'")
        sys.exit(1)
